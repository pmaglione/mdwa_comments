...
<body>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<c:if test="${wrBoxed}">
			<script>
				jQuery("#page2FormBean").prop("action", "${wrBaseURI}form_page2.do${wrAjax ? '#!ajax=true' : ''}");
			</script>
		</c:if>
 ...
 <a class="" href="<webratio:Link link="page2.link"/>">
   Create Comment
	...
	<tr>
		<td width="100%"></td>
    		<td nowrap="nowrap">	
 <a class="" href="<webratio:Link link="ln4"/>">
   Create Product
</a>
 </td>
	</tr>
...
<table width="100%">
	<tr>
		<td align="center"><h1>Create Comment</h1></td>
	</tr>
</table>
<table>
	<tr>
		...
		<div class="plain EntryUnit">
		    <html:hidden property="enu1Key" styleId="enu1Key"></html:hidden> 
				<table>
					...
					<tr class="row">
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:textarea styleId="fld3" styleClass=" field" cols="35" rows="8" property="fld3" readonly="false"/>
						</td>
								<td class="error"><span class=" error"><html:errors property="fld3"/></span></td>
					 	</tr>
					<tr class="row">
							<th valign="middle" class=" header">
								Product
						...
						<td valign="middle" nowrap="nowrap" class=" value">
								<html:select styleId="sfld2" styleClass="wr-submitButtons:ln2  selectionfield" property="sfld2" disabled="false">
			    ...
			    <html:options property="sfld2List" labelProperty="sfld2LabelList_locale"/>
					...
					<table>
				      <tr>
					  <td> <input title="Save comment" onclick="$('#page2FormBean')[0].target='_self'" class=" button"  id="button:ln2" name="button:ln2" type="submit" value="Save comment">
 </td>
					</tr>
				    </table>
				   </td>
