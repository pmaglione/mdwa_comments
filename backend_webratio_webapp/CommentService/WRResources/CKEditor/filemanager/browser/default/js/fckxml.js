		...
		oXmlHttp.onreadystatechange = function()
		{
			if ( oXmlHttp.readyState == 4 )
			{
				...
				try
				{
					...
					if (oXml && (typeof oXml.selectNodes == "undefined" && typeof oXml.evaluate == "undefined")) {// IE 11
						var dom = new ActiveXObject("msxml2.DOMDocument");
						dom.loadXML(oXmlHttp.responseText)
						oXml = dom;
						oFCKXml.ie = true;
					} 
				}
...
{
	if ( navigator.userAgent.indexOf('MSIE') >= 0 || this.ie)		// IE
